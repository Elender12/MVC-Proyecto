...
Hora de salida:
    ...
    <pre></pre>
    <form method="post" action="../Usuario/anular">    
        <input type="number" name="anular" max="31" min="1" placeholder="Dia" required>
        <button type="submit">Borrar Dia</button>
    </form>

    <pre></pre>
    <form method="post" action="/pass">
        <button type="submit" name="modificarPass">Modificar Password</button>
    </form>
